...
\begin{axis}[ 
	...
	\addlegendentry{PH} 
	\addplot[PHM] table [selectcoords={0}{15},x=dim,y expr=1e9/\thisrow{load/n}, col sep=tab] {dimsP/PHC_IPP-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{8},x=dim,y expr=1e9/\thisrow{load/n}, col sep=tab] {dimsP/QKDZ-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: Insertion rates for CU-P}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{load/n}, col sep=tab] {dimsR/QKDZ-R-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: Insertion rates for CU-R}
...
\begin{axis}[ 
	...
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{8},x=dim,y expr=1e9/\thisrow{load/n}, col sep=tab] {dimsP/QKDZ-P-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: Insertion rates for CL-P}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{load/n}, col sep=tab] {dimsR/QKDZ-R-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: Insertion rates for CL-R}
