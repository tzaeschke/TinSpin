...
%	\addlegendentry{CBZ} 
	...
	\addlegendentry{PH} 
	\addplot[PHM] table [selectcoords={0}{15},x=dim,y expr=1e9/\thisrow{1-NN2}, col sep=tab] {dimsP/PHC_IPP-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{13},x=dim,y expr=1e9/\thisrow{1-NN2}, col sep=tab] {dimsP/QKDZ-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: 1-NN query rates for CU-P}
...
%	\addlegendentry{CBZ} 
	...
	\addlegendentry{PH} 
	\addplot[PHM] table [selectcoords={0}{15},x=dim,y expr=1e9/\thisrow{10-NN2}, col sep=tab] {dimsP/PHC_IPP-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{13},x=dim,y expr=1e9/\thisrow{10-NN2}, col sep=tab] {dimsP/QKDZ-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: 10-NN query rates for CU-P}
...
%	\addlegendentry{CBZ} 
	...
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{13},x=dim,y expr=1e9/\thisrow{1-NN2}, col sep=tab] {dimsP/QKDZ-P-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: 1-NN query rates for CL-P}
...
%	\addlegendentry{CBZ} 
	...
	\addlegendentry{PHM} 
	\addplot[QKDZ] table [selectcoords={0}{13},x=dim,y expr=1e9/\thisrow{10-NN2}, col sep=tab] {dimsP/QKDZ-P-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{tikzpicture}
	\centering
	\caption{DIM: 10-NN query rates for CL-P}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{1-NN2}, col sep=tab] {dimsR/QKDZ-R-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: 1-NN query rates for CU-R}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{10-NN2}, col sep=tab] {dimsR/QKDZ-R-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: 10-NN query rates for CU-R}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{1-NN2}, col sep=tab] {dimsR/QKDZ-R-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: 1-NN query rates for CL-R}
...
\begin{axis}[ 
	...
	\addlegendentry{STRZ} 
	\addplot+[QKDZ] table [selectcoords={0}{11},x=dim,y expr=1e9/\thisrow{10-NN2}, col sep=tab] {dimsR/QKDZ-R-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
\end{axis}
\end{tikzpicture}
	\centering
	\caption{DIM: 10-NN query rates for CL-R}
