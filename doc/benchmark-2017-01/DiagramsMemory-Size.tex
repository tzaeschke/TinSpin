...
%\end{figure}
\end{subfigure}
	\caption{Memory usage per point entry for the OSM ($d=2$), CUBE ($d=3$) and CLUSTER ($d=3$) datasets}
...
%\end{figure}
\end{subfigure}
	\caption{Memory usage per rectangle entry for the OSM ($d=2$), CUBE ($d=3$) and CLUSTER ($d=3$) datasets}
