...
%	\addlegendentry{RSS} 
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{6},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeP/QTZ-P-OSM(1.0,0.0,null).txt};
	\addlegendentry{QZ} 
...
%	\addlegendentry{RSS} 
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{6},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeP/QTZ-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QZ} 
...
%	\addlegendentry{RSS-P} 
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{6},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeP/QTZ-P-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QZ} 
...
\end{tikzpicture}
	...
	\label{fig:remCL-P}
\end{subfigure}
	\caption{Removal rates for the OSM ($d=2$), CUBE ($d=3$) and CLUSTER ($d=3$) datasets}
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{5},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeR/QTZ-R-OSM(1.0,0.0,null).txt};
	\addlegendentry{QZ} 
		\end{axis} 
	\end{tikzpicture}
	\centering
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeR/QTZ-R-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QZ} 
	\legend{} %disable legend
		\end{axis} 
	\end{tikzpicture}
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x=N,y expr=1e9/\thisrow{unload/n}, col sep=tab] {sizeR/QTZ-R-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QZ} 
	\legend{} %disable legend
		\end{axis} 
	\end{tikzpicture}
