...
%%	\addlegendentry{CBZ} 
	...
	%\addlegendentry{KDS} 
	%\addplot+[QTZ] table [selectcoords={0}{5},x expr=\thisrow{q2-n}/1000,y=q2/n, col sep=tab] {sizePWQS/QTZ-P-CUBE(1.0,0.0,null).txt};
	%\addlegendentry{QZ} 
...
\begin{figure*}%[thb]
	\pgfplotsset{
		...
		every axis/.append style={xmode=log, ymode=log, ymin={1e2}, ymax={1e7}, 
				height=7cm, width=6.4cm, grid=major, xlabel={query result size $|Q|$}, font=\scriptsize, }
	}
...
%	\addlegendentry{CBF} 
  \addplot+[CBZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizePWQS/CBZ-P-OSM(1.0,0.0,null).txt};
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizePWQS/QTZ-P-OSM(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
%	\addlegendentry{CBF} 
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizePWQS/QTZ-P-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
%	\addlegendentry{CBF} 
	...
	\addlegendentry{KDS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizePWQS/QTZ-P-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
...
\end{subfigure}
	\caption{Varying query result size with $N=10^6$ with the OSM ($d=2$), CUBE ($d=3$) and CLUSTER ($d=3$) datasets}
...
%%	\addlegendentry{KDS} 
	%\addplot+[QTZ] table [selectcoords={0}{5},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizeRWQS/QTZ-R-CUBE(1.0E-5,0.0,null).txt};
	%\addlegendentry{QZ} 
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizeRWQS/QTZ-R-OSM(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
		\end{axis} 
	\end{tikzpicture}
	\centering
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizeRWQS/QTZ-R-CUBE(1.0,0.0,null).txt};
	\addlegendentry{QTZ} 
	\legend{} %disable legend
		\end{axis} 
	\end{tikzpicture}
...
%	\addlegendentry{XTS} 
	\addplot+[QTZ] table [selectcoords={0}{4},x expr=\thisrow{q2-n}/10000,y expr=1e9/(\thisrow{q2/n}*\thisrow{q2-n})*10000, col sep=tab] {sizeRWQS/QTZ-R-CLUSTER(5.0,0.0,null).txt};
	\addlegendentry{QTZ} 
	\legend{} %disable legend
		\end{axis} 
	\end{tikzpicture}
