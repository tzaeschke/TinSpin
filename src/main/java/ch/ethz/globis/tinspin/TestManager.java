...
//			testSeries(TST.CLUSTER, IDX.CBZ, 3, 3.5, sizesData);
...
//			suiteDimsR(TST.CUBE, IDX.XTS, 1, 1.0);
			...
			testSeriesR(TST.CLUSTER, IDX.XTS, 3, 5.0, sizesData);
			...
			suiteDimsR(TST.CLUSTER, IDX.XTS, 1, 5.0);
